...
private slots:
   ...
   void testLinkedSeveralItems()
   {
       ...
       QVERIFY(listLinked->isInList(5));
       QVERIFY(listLinked->isInList(7));
       QVERIFY(listLinked->isInList(99));
       QVERIFY(listLinked->isInList(199));
   }
   ...
   void testDoubleSeveralItems()
   {
       ...
       QVERIFY(listDouble->isInList(5));
       QVERIFY(listDouble->isInList(7));
       QVERIFY(listDouble->isInList(99));
       QVERIFY(listDouble->isInList(199));
   }
